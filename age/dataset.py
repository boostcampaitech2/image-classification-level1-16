import os
from transform import get_transform, get_age_transform_ff, get_age_transform_mega
...
def get_age_dataset_ff(df_train1, df_train2, df_valid, target='age'):
    transform_train1, transform_train2, transform_valid = get_age_transform_ff()
...
def get_age_dataset_mega(df_train1, df_train2, df_valid, target='age'):
    transform_train1, transform_train2, transform_valid = get_age_transform_mega()
    train_dataset1 = MaskTrainDataset(df_train1, transform_train1, target)
    train_dataset2 = MaskTrainDataset(df_train2, transform_train2, target)
    train_dataset = ConcatDataset([train_dataset1, train_dataset2])
    valid_dataset = MaskTrainDataset(df_valid, transform_valid, target)
